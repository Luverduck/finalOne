...
<script src="https://code.jquery.com/jquery-3.6.1.js"></script>
  ...
  function ahzitInfo(){
      ...
      //500글자 초과시 입력 불가 처리 = 15글자 넘어가면 잘라내기
      var size = text.length;
      while(size > 500){
          tag.value = tag.value.substring(0, size-1);
          size--;
...
<div class="container">
	...
	<div class="row">
		<p>소모임 리더 : ${sessionScope.loginId}</p>
	</div>
	...
	<div class="row">
		...
		<div>
			<select name="sido" id="sido1"></select>  <%--지역선택 시/도 --%>
			<select name="gugun" id="gugun1"></select><br><br> <%--지역선택 군/구 --%>
		</div>
	</div>
		...
		<div class = "row">
			...
			<div>
				<input type="radio"  name="ahzitSort" id="ex_rd1" value="운동" checked><label id="ex_rd1">운동</label><br>
				<input type="radio"  name="ahzitSort" id="ex_rd2" value="스터디"><label id="ex_rd2">스터디</label><br>
				<input type="radio"  name="ahzitSort" id="ex_rd3" value="일상"><label  id="ex_rd3">일상</label><br>
				<input type="radio"  name="ahzitSort" id="ex_rd4" value="팬클럽"><label  id="ex_rd4">팬클럽</label><br>
				<input type="radio"  name="ahzitSort" id="ex_rd5" value="음악"><label  id="ex_rd5">음악</label><br>
				<input type="radio"  name="ahzitSort" id="ex_rd6" value="스포츠"><label  id="ex_rd6">스포츠</label><br>
				<input type="radio"  name="ahzitSort" id="ex_rd7" value="여행"><label  id="ex_rd7">여행</label><br>
				<input type="radio"  name="ahzitSort" id="ex_rd8" value="맛집"><label  id="ex_rd8">맛집</label><br><br>
			</div>
		</div>
			...
			<div class="row">
				<p>아지트 이름</p>	
				<div>
					<input name="AhzitName"  class="ahzitName-input"  oninput="ahzitName();"  type="text" placeholder="아지트 이름 입력"  autocomplete="off" required>			
				</div>
			</div>
			...
			<div class="row">
				<p>아지트 소개</p>	
				<div>
					<textarea name="AhzitInfo"  class="ahzitInfo-input"  oninput="ahzitInfo();"  type="text" placeholder="아지트 소개"  autocomplete="off" required></textarea>			
				</div>
			</div>
			
			<%--아지트 이름 입력창 글자수 표현--%>
			<div>
				<span class="ahzitInfo-input-length">0</span> / 500<br><br>
			</div>
